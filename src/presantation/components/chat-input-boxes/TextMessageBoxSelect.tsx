...
type TextMessageBoxProps = {
  onSendMessage: (mesdage: string, selectedOption:string) => void;
  placeholder?: string;
    ...
    >
      <div className="flex-grow">
        <div className="flex">
          ...
          <select 
            name="select"
            className="w-2/% ml-5 border rounded-xl text-gray-800 focus:outline-none focus:border-indigo-300 pl-4 h-10"
